...
# -*- encoding: utf-8 -*-
# stub: coderunner 1.0.2 ruby lib
# stub: ext/extconf.rb
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<graphkit>, ["~> 0.4"])
      s.add_runtime_dependency(%q<parallelpipes>, ["~> 1.0"])
      s.add_runtime_dependency(%q<rubyhacks>, ["~> 0.1"])
      s.add_runtime_dependency(%q<rb-gsl>, ["~> 1.16"])
      s.add_runtime_dependency(%q<gsl_extras>, ["~> 0.4"])
      s.add_runtime_dependency(%q<hostmanager>, ["~> 1.2"])
      s.add_runtime_dependency(%q<command-line-flunky>, ["~> 1.0"])
      ...
      s.add_dependency(%q<graphkit>, ["~> 0.4"])
      s.add_dependency(%q<parallelpipes>, ["~> 1.0"])
      s.add_dependency(%q<rubyhacks>, ["~> 0.1"])
      s.add_dependency(%q<rb-gsl>, ["~> 1.16"])
      s.add_dependency(%q<gsl_extras>, ["~> 0.4"])
      s.add_dependency(%q<hostmanager>, ["~> 1.2"])
      s.add_dependency(%q<command-line-flunky>, ["~> 1.0"])
